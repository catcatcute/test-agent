...
- [ ] 能用 AsyncIO 写一个并发调用多个 LLM 的脚本
- [ ] 能使用 Pydantic 定义 LLM 的结构化输出
- [ ] 理解 Token 计费方式和上下文窗口概念
- [ ] 能调用 OpenAI/Claude API 完成基础对话和 Function Calling
...
- [ ] 理解 ReAct 模式的运行机制
- [ ] 能构建一个带工具调用（搜索/计算器/API 查询）的 Agent
